...
final List<String> verificationReasons = [
  ...
  'Enhanced Security: Protect your account  and confirm order securely',
  'Effortless Rescheduling: Easily address issues with a quick call'
];
String API_KEY = 'AIzaSyAufPrvRMe8Zodf9VJQmNuCyudiXuSB4Hs';

String api = 'AIzaSyAufPrvRMe8Zodf9VJQmNuCyudiXuSB4Hs';
